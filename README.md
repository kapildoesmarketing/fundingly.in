...
- Frontend fetches structured funding rounds directly from `data/data.json`.
...
└── data/
    └── data.json         # Master dataset of funding rounds (committed periodically)
```
...
1. **GitHub Pages Router (`404.html`)**: Extracts the domain and checks `data/data.json`.
